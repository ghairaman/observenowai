...
<div className="pointer-events-none absolute inset-0 flex items-center justify-center">
  <div
    className="mt-[220px] w-[800px] h-[600px] md:w-[1400px] md:h-[900px] rounded-full blur-[160px] opacity-70"
    style={{
      background:
...
<div className="pointer-events-none absolute inset-0 flex justify-center">
  <div
    className="mt-[480px] w-[800px] h-[500px] md:w-[1400px] md:h-[700px] rounded-full blur-[140px] opacity-80"
    style={{
      background:
