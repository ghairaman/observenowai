...
/>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6">
        ...
        <motion.div 
          ...
          className="text-center max-w-3xl mx-auto mb-8 relative md:-left-8 lg:-left-12"
        >
          <h1 className="font-sora text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-center">
            <span className="inline-block whitespace-nowrap">
              <span>ObserveNow.AI</span> vs RocketReach
            </span>
            <br />
            <span className="inline-block whitespace-nowrap text-[#72339F]/80"> Affordable Contact Discovery</span>
          </h1>
        </motion.div>

        <p className="font-sora text-xs sm:text-sm text-muted-foreground text-base md:text-lg mb-8 max-w-3xl mx-auto text-center">
          Looking for an RocketReach alternative? <span className="violet-gradient-text">ObserveNow.AI</span> delivers 91% accuracy from LinkedIn at a fraction of the cost. Compare features, pricing, and accuracy side-by-side.
        </p>
