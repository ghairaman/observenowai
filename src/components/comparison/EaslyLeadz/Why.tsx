...
const contactDiscoveryCards = [
  {
    ...
    description:
      "EasyLeadz is primarily India-focused. ObserveNow.AI works worldwide — find contacts in the US, Europe, Asia, and beyond. One tool for all your prospecting needs.",
  },
  {
    icon: Target,
