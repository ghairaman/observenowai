...
const faqs = [
  {
    question: "Is ObserveNow.AI better than EasyLeadz for Indian contacts?",
    answer: "Yes. ObserveNow.AI offers 91% accuracy for Indian contacts (vs EasyLeadz's ~60-70%), plus a dedicated MSME directory with 1M+ registered Indian businesses. ObserveNow.AI also has a Director Phone feature specifically for finding C-level and director contacts in India. ",
  },
  {
