        ...
        >
          <h1 className="font-sora text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-center">
            <span className="inline-block whitespace-nowrap">
              <span>ObserveNow.AI</span> vs EasyLeadz
            </span>
            <br />
            <span className="inline-block whitespace-nowrap text-[#72339F]/80">Better Accuracy, Global Reach</span>
          </h1>
        </motion.div>

        <p className="font-sora text-xs sm:text-sm text-muted-foreground text-base md:text-lg mb-8 max-w-3xl mx-auto text-center">
          Looking for an EasyLeadz alternative? <span className="violet-gradient-text">ObserveNow.AI</span> delivers 91% accuracy with global coverage, a credit refund guarantee, and a 4.9/5 Chrome Web Store rating.
        </p>
