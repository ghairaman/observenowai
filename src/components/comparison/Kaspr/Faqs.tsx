...
const faqs = [
  ...
  },
  {
    ...
    answer: " Kaspr offers LinkedIn automation workflows and sequences, which ObserveNow.AI does not. However, ObserveNow.AI excels at the core task: finding accurate phone numbers faster and cheaper. If you need automation, Kaspr adds value; if you need accuracy and affordability, ObserveNow.AI wins.",
  },
  {
