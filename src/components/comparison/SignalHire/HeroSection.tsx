        ...
        >
          <h1 className="font-sora text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-center">
            <span className="inline-block whitespace-nowrap">
              <span>ObserveNow.AI</span> vs SignalHire
            </span>
            <br />
            <span className="text-center whitespace-nowrap text-[#72339F]/80 mt-2">  Which Contact Finder Wins?</span>
          </h1>
        </motion.div>

        <p className="font-sora text-xs sm:text-sm text-muted-foreground text-base md:text-lg mb-8 max-w-3xl mx-auto text-center">
          Looking for an SignalHire alternative? <span className="violet-gradient-text">ObserveNow.AI</span>  delivers 91% accuracy with pay-per-use pricing. Compare features, pricing, and accuracy side-by-side.
        </p>
