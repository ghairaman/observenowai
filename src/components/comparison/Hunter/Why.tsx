import { DollarSign, Linkedin, Phone } from "lucide-react";
...
const contactDiscoveryCards = [
  {
    icon: Phone,
    title: "Phone Numbers Hunter Can't Find",
    description:
      "Hunter.io only finds email addresses. ObserveNow.AI finds direct phone numbers from LinkedIn profiles - the valuable contact data for sales outreach and closing deals.",
  },
  {
    icon: Linkedin,
