...
const faqs = [
  {
    ...
    answer: "Yes. ObserveNow.AI offers 91% phone accuracy at $9 for 250 credits vs Hunter.io's $49+/month. ObserveNow.AI also provides 100% credit refund for wrong numbers and has a 4.9/5 Chrome Web Store rating vs Hunter.io's 4.5/5. ",
  },
  {
  ...
  },
  {
    ...
    answer: "Hunter.io costs $49/month billed annually ($588/year). ObserveNow.AI's pay-per-use model at $9/250 credits means you could save 80%+ depending on usage. With ObserveNow.AI's refund guarantee, your effective cost per accurate contact is even lower. ",
  },
  {
    question: "Does Hunter.io refund credits for wrong phone numbers?",
    answer: " No. Hunter.io does not offer credit refunds for inaccurate data. ObserveNow.AI provides 100% credit refund for any wrong phone numbers, ensuring you only pay for accurate contacts that you can actually reach. ",
  },
];
