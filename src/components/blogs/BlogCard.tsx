...
const BlogCard = ({ post, featured = false }: BlogCardProps) => {
  if (featured) {
    return (
      <div className="group grid overflow-hidden rounded-[28px] border border-[#72339F]/10 bg-[#F5EEFB] shadow-[0_22px_70px_rgba(114,51,159,0.1)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_28px_90px_rgba(114,51,159,0.16)] lg:grid-cols-[1.2fr_1fr]">
  ...
  return (
    <div className="group grid gap-6 overflow-hidden rounded-[28px] border border-[#72339F]/10 bg-[#F5EEFB] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#72339F]/20 hover:shadow-[0_18px_50px_rgba(114,51,159,0.14)] sm:grid-cols-[250px_1fr]">
